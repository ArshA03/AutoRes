...
def extract_keywords(chat_history):
    ...
    with open('tests/resources/texts/keywords.txt', 'w') as file:
...
def find_skills(chat_history):
    ...
    # Save the response to a .txt file
    with open('tests/resources/texts/skills.txt', 'w') as file:
...
def peer_skills(chat_history):
    ...
    # Save the response to a .txt file
    with open('tests/resources/texts/peer_skills.txt', 'w') as file:
        file.write(skills_response.strip())


def tailor_resume(chat_history, res_name):

    with open('tests/resources/texts/keywords.txt', 'r') as file:
        keywords = file.read().strip()

    with open(os.path.join(output_folder_path, res_name), 'r') as file:
    ...
    # Save the response to a .txt file
    with open('tests/resources/texts/tailored_resume.txt', 'w') as file:
...
with open('tests/resources/texts/jd.txt', 'r') as file:
...
doc_to_txt(folder_path, output_folder_path)
